...
func TestRenderLaunchAgentUsesAbsoluteAria2cPathWithoutShell(t *testing.T) {
	...
	assertContains(t, rendered, "<key>SoftResourceLimits</key>")
	assertContains(t, rendered, "<key>HardResourceLimits</key>")
	assertContains(t, rendered, "<integer>65536</integer>")
