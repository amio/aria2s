...
func TestDefaultConfigIncludesFriendlyDefaults(t *testing.T) {
	...
	assertContains(t, rendered, "dht-entry-point=router.bittorrent.com:6881")
	assertContains(t, rendered, "dht-entry-point=dht.transmissionbt.com:6881")
	assertContains(t, rendered, "enable-dht6=true")
